...
main()
    ...
    arrayalignment = 64;
    //arrayalignment = 1 << 16; // Align to 64KiB
...
//  long long cyc = PAPI_get_real_cyc();
//  long double CPU_FREQ = 0.5E-9; // Frequencies given in hz
//  double sec = (double)(cyc * CPU_FREQ * 10.0); // Multiply by 10 because PMU_FREQ
//  printf("#### Cyc: %llu \n ####", cyc);
//  printf("#### Sec: %f \n ####", sec);
//  return sec;
}
